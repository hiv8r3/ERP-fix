# read in data
dat = read.delim("./Analyses with full sample/ERP quant data/2 Cat dat/Trial by trial data/AllSubs_Cat_TBTAverages_P2_meanAmp.txt")
...
m1 = lmer(MeanAmp ~ 1 + (1|Subject) + (1|Electrode) + (1|Trial), data = dat)
summary(m1)
...
sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2 P2_Cat_InterceptOnly_TBTdat.txt")
summary(m1)
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.1 P2_Cat_varyingInterceptModel_TBTdat.txt")
# summary(m3)
# "________________________________________________________________________________________________"
# coef(m3)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.2 P2_Cat_MaximalModel_TBTdat.txt")
# summary(m4)
# "________________________________________________________________________________________________"
# coef(m4)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.3 P2_Cat_randomEffectSubject_TBTdat.txt")
# summary(m5)
# "________________________________________________________________________________________________"
# coef(m5)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.4 P2_Cat_randomEffectSubject_randomInterceptTrial_TBTdat.txt")
# summary(m6)
# "________________________________________________________________________________________________"
# coef(m6)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.4.1 P2_Cat_randomEffectSubject_randomEffectTrial_TBTdat.txt")
# summary(m6.1)
# "________________________________________________________________________________________________"
# coef(m6.1)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.5 P2_Cat_randomEffectSubject_fixedTrial_TBTdat.txt")
# summary(m7)
# "________________________________________________________________________________________________"
# coef(m7)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2 Cat task/P2 Analyses/2.6 P2_Cat_randomEffectSubject_fixedTrialWithInteractions_TBTdat.txt")
# summary(m8)
# "________________________________________________________________________________________________"
# coef(m8)
# "________________________________________________________________________________________________"
...
require(ggplot2)
dat$plotCond = paste(dat$Race, dat$Fix, sep="_")

ggplot(dat, aes(Trial, MeanAmp, color = plotCond)) +
  geom_point(size=.5, alpha = 1/10) +
  geom_smooth(method="lm") +
  ggtitle("Trial by trial data") +
  coord_cartesian(ylim=c(-40,40))

ggplot(dat, aes(Trial, MeanAmp, color = plotCond)) +
  geom_point(size=.5, alpha = 1/10) +
  geom_smooth(method="lm") +
  ggtitle("Trial by trial data (zoomed in)") +
  coord_cartesian(ylim=c(-5,5))


ggplot(dat, aes(MeanAmp)) +
  geom_histogram() +
  facet_wrap(~plotCond) +
  ggtitle("TBT data")
