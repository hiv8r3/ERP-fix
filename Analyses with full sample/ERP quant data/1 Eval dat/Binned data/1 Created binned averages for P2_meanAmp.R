...
write.table(dat.all, paste(path, "Binned Data/AllSubs_BinnedAverages_P2_meanAmp.txt", sep = ""),sep = "\t", row.names=F)
write.table(BinningInfoTotal, paste(path, "Binned Data/BinningInfo_P2_meanAmp.txt", sep = ""),sep = "\t", row.names=F)
