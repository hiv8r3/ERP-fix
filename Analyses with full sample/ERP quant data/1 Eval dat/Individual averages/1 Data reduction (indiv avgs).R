...
write.table(P2dat, "./Analyses with full sample/ERP quant data/1 Eval dat/Individual averages/AllSubs_IndivAverages_P2.txt", row.names = F, sep = "\t")
...
write.table(N170dat, "./Analyses with full sample/ERP quant data/1 Eval dat/Individual averages/AllSubs_IndivAverages_N170.txt", row.names = F, sep = "\t")
