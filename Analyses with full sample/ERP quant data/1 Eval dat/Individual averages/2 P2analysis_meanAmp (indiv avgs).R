dat = read.delim("./Analyses with full sample/ERP quant data/1 Eval dat/Individual averages/AllSubs_IndivAverages_P2_meanAmp.txt")
...
# sink(file = "./Analyses with full sample/Model outputs/2 P2_Eval_InterceptOnly_IndivAvgDat.txt")
# summary(m1)
...
# sink(file = "./Analyses with full sample/Model outputs/2.1 P2_Eval_varyingInterceptModel_IndivAvgDat.txt")
# summary(m3)
# "________________________________________________________________________________________________"
# coef(m3)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2.2 P2_Eval_MaximalModel_IndivAvgDat.txt")
# summary(m4)
# "________________________________________________________________________________________________"
# coef(m4)
# "________________________________________________________________________________________________"
...
# sink(file = "./Analyses with full sample/Model outputs/2.4 P2_Eval_randomEffectsSubject_IndivAvgDat.txt")
# summary(m6)
# "________________________________________________________________________________________________"
# coef(m6)
# "________________________________________________________________________________________________"
...
sink(file = "./Analyses with full sample/Model outputs/P2 analyses/Repeated measures ANOVA/1 P2_meanAmp_RManova_IndivAvgDat.txt")
...
sink(file = "./Analyses with full sample/Model outputs/P2 analyses/Repeated measures ANOVA/1.2 P2_meanAmp_RManova_electrodeFixed_IndivAvgDat.txt")
...
sink(file = "./Analyses with full sample/Model outputs/P2 analyses/Repeated measures ANOVA/1.3 P2_meanAmp_RManova_electrodeFixedWithInteractions_IndivAvgDat.txt")
"aov(AvgAmp ~ faceRace*FixArea*Electrode + Error(Subject/(faceRace*FixArea*Electrode)), data = select) "
summary(aov3)
sink()
