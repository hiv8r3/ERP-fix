...
# looking just at eyes fixation: main effect of wordVal and wordVal x FaceRace interaction
m5 <- lmer(TargetWord.RT ~ 1 + faceRace * wordVal + (1|Subject) + (1|TargetWord), data=corTrials[corTrials$FixArea == "eyes",])
summary(m5)
